...
?>
<?php
    if(isset($_POST['show_id']) && isset($_POST['rating'])){
        $rating = $_POST['rating'];
...
<body style="background-color: #15131a;">
    ...
    <div class="card card-body" style="margin: 20px 80px; padding:20px;background-color:#b1b8c7;">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                    <h6 style="color: #15131a; text-align:left;margin:10px 0;padding:10px 0;">Rating:</h6>
            </div>
            <div class="col-md-4">
                    <h6 style="color: #15131a; text-align:left;margin:10px 0;padding:10px 0;"><?php echo $rating ?></h6>
            </div>
        </div>
    </div>
