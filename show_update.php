...
<?php
    if(isset($_POST['submit']) && isset($_FILES['show_img']) && isset($_GET['show_id'])){
        ...
        if($test == 0){
            $sql = "UPDATE tvshows set show_name = '$show_name', channel = '$channel', time = '$time', day = '$day', schedule = '$schedule' , category =  '$category', show_img = '$new_img_name' where show_id = '$show_id'";
...
<body style="background: #222124; color:#b1b8c7; font: size 14px;">
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <form action="" class="login-form text-center" method="POST" enctype="multipart/form-data">
            <h3 class="mb-5 font-weight-light text-uppercase">Update Show Details</h3>
